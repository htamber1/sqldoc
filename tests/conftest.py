...
def fake_table_rows():
    ...
    return {
        ...
        "columns": [
            FakeRow(column_name="Id", data_type="int", max_length=4,
            ...
            FakeRow(column_name="CustomerID", data_type="int", max_length=4,
                    precision=10, scale=0, is_nullable=1,
                    is_primary_key=0, is_foreign_key=1, references_table="Customer",
                    references_column="Id", description=None,
                    is_computed=0, computed_definition=None, default_definition=None,
                    fk_on_delete="CASCADE", fk_on_update="NO_ACTION"),
            FakeRow(column_name="LineTotal", data_type="money", max_length=8,
                    precision=19, scale=4, is_nullable=1,
                    ...
                    fk_on_delete=None, fk_on_update=None),
            FakeRow(column_name="Status", data_type="int", max_length=4,
                    precision=10, scale=0, is_nullable=0,
                    is_primary_key=0, is_foreign_key=0, references_table=None,
                    references_column=None, description=None,
